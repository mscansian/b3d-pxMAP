If CommandLine$() <> "dev"
	Print "Pexe's Worldcraft"
	Print "MIB Release"
	Print ""
	Print "W S A D = Movem personagem"
	Print "E = Aperta botões"
	Print "Espaço = Voa"
	Print ""
...
PXWC_LoadMap("Mapas/map3.map")
PXWC_BuildMap()

;Acha a entidade Player Start
Player = Find_EntityByClassname%("player_start")
If Player = -1 Then RuntimeError("Player_Start não definido")
